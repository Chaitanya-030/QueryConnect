...
public class App {
    ...
    public static String manipulate(String kqlQuery)   {
        ...
        String temp_sparqlQuery ="PREFIX kql: <http://kql#> " + preprocessKQLQuery(kqlQuery);

        // Create a query object from the SPARQL query string
        Query query = QueryFactory.create(temp_sparqlQuery);
        ...
        Query obj = OpAsQuery.asQuery(transformedOp);

        // convert query object into string
        String sparqlQuery = obj.toString();
